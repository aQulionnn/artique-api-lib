...
import { CreateArtworkRequest, UpdateArtworkDescriptionRequest, UpdateArtworkRequest } from "../types/artwork";
...
import {SignInRequest, SignUpRequest} from "../types/account";
